            ...
            <tbody>
                ...
                <tr  class="text-item">
                    ...
                    <td  class="notSLH" style="width: 130px;">
                        <a class="btn " href="/content/activity/five-activity-add?id=<?php echo $v['id'] ; ?>" >修改</a>
                        <a href='#' class="btn" onclick="javascript:if(confirm('确定删除吗？')){location.href='/content/activity/five-activity-delete?id=<?php echo $v['id']; ?>'}" >删除</a>
                    </td>
                </tr>
                <?php
                    }
