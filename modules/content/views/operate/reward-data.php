...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">奖池数据</li>
    </ul>
    <ul class="nav">
    </ul>
    <form action="/content/operate/reward-data" method="get" class="form-horizontal">
        <table class="table">
            <tr>
                <td width="100">
                    日期：
...
<!--                </td>-->
                <td style="float: right">
                    ...
                    <a href="#" class="btn" onclick="rewardExcel()">导出</a>
                </td>
                <td></td>
            </tr>
        </table>
...
<script>
    function rewardExcel(){
        var date = $('#beginTime').val();
        if(!date){
            alert('请选择日期');return false;
        }
        if(confirm('确定导出吗？')){
            window.location.href = '/content/api/reward-excel?date='+date;
        }else{
            return false;
        }
    }
