...
<div class="span10" id="datacontent">
    <ul class="breadcrumb">
        ...
        <li class="active">时来运转奖池数据（天/图）</li>
    </ul>
    <ul class="nav">
    </ul>
    <form action="/content/operate/lottery-data-img" method="get" class="form-horizontal">
        <table class="table">
            <tr>
                <td>
                    日期：
    ...
    <form action="/content/operate/lottery-data-img" method="post">
