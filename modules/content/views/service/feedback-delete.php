    ...
    <form action="/content/service/feedback-delete" method="get" class="form-horizontal">
        <table class="table">
            <tr>
                ...
                <td>
                    <input  style="height: 20px;width: 100px" type="text"   id="name"  name="name" value="<?php echo isset($_GET['name'])?$_GET['name']:''?>"/>
                </td>
                <td>
                    检索内容：
                </td>
        ...
        <table class="table table-hover ">
            ...
            foreach($data as $kss => $v) {
                ...
                <tr class="tdSpan tdBorder">
                    ...
                    <td  class="notSLH" >
                        <div>
                            <a class="btn" id="serviceAlter"  href="Javascript:if(confirm('确认删除该反馈信息？')){location.href='/content/service/delete-feedback?id=<?php echo $v['id'];?>'}">删除</a>
                        </div>
                    </td>
                </tr>
                <?php
